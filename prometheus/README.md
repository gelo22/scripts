...
~~~~
kubectl edit servicemonitor -n default rancher-monitoring-apiserver
    metricRelabelings:
      - sourceLabels: [ __name__ ]
...
kubectl edit servicemonitor -n kube-system rancher-monitoring-kubelet
    metricRelabelings:
      - sourceLabels: [ __name__ ]
...
kubectl edit servicemonitor -n cattle-monitoring-system rancher-monitoring-kube-state-metrics
    metricRelabelings:
      - sourceLabels: [ __name__ ]
...
kubectl edit servicemonitor -n cattle-monitoring-system    rancher-monitoring-node-exporter
    metricRelabelings:
      - sourceLabels: [ __name__ ]
